...
/**
 * Cette classe permet de modifier le rôle d'utilisateur déjà enregistré
 */
public class EditRole extends javax.swing.JFrame {

    /**
     * Cette classe permet d'initialiser la fenetre
     */
    public EditRole() {
        initComponents();
    ...
    /**
     * >Cette méthode permet d'initialiser les différent composant de la fenetre
     */
    ...
    /**
     * Cette méthode permet la gestion d'evenement sur le bouton validation. il vérifie
     * que l'utilisateur modifier ne soit pas l'auteur de l'Instance et dans ce cas présent, modifie l'utilisateur.
     * @param evt Event
     */
